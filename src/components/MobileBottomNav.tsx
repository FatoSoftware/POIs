    ...
    <nav className="md:hidden bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg border-t border-slate-200/90 dark:border-slate-800 shrink-0 z-30 px-2 py-1.5 shadow-lg">
      <div className="flex items-center justify-around max-w-md mx-auto">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center min-w-[56px] min-h-[46px] py-1 px-2 rounded-2xl transition-all active:scale-95 ${
            viewMode === 'map'
        ...
        <button
          ...
          className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white shadow-lg shadow-teal-500/30 active:scale-90 transition-transform -mt-4 border-2 border-white dark:border-slate-900"
        ...
        <button
          ...
          title="Vista solo lista"
        >
          <LayoutGrid className="w-5 h-5 mb-0.5" />
          <span className="text-[10px] leading-none">Lista</span>
        </button>
